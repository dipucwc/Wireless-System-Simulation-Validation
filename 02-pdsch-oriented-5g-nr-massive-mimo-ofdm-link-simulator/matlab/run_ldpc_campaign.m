...
%% Smoke Test:
%%
 smokeTest = true;                                  % True: 4 frames/point for pipeline validation. False: full run.
...
if smokeTest
    ...
    numFrames = cfg.numFrames;                     % Full campaign frame count, identical to the uncoded run.
end
...
outCsvRel = '../04_Simulation_Results/MATLAB/csv/matlab_results_ldpc.csv';   % Result file of this campaign.
...
hold off;
saveas(figure(18), fullfile(figDir,'bler_ldpc_vs_snr.png'));
...
hold off;
saveas(figure(19), fullfile(figDir,'throughput_ldpc_vs_snr.png'));
